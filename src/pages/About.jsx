...
function About() {
  return (
    <Page>
      <section>
        <h2>About</h2>
        <p>In 2015, I was studying HTML, jQuery and CSS, getting myself ready for starting to work as web developer. At the moment, I decided to rewrite an old snake game that I made in Java 6 with desktop forms on my Computer Scicence times.</p>
        ...
        <p>I made a layout inspired in the 2000's, same time that I played a game like this in a Nokia 2280. This game is full of nostalgia and oposes with the idea of simple and flat layouts (c'mon, we have so cool CSS features for years and all we do is flat and square websites??).</p>
